odoo.define('stripe_account_move.PaymentStripe',['@web.core', '@web.AbstractAction'], function(require) {
    'use strict';

    var core = require('web.core');
    var AbstractAction = require('web.AbstractAction');

    var PaymentStripe = AbstractAction.extend({
        contentTemplate: 'StripePayment',
        events: {
            'click .btn-stripe-payment': 'onClickStripePayment',
        },
        init: function(parent, options) {
            this._super.apply(this, arguments);
        },
        start: function() {
//            this.$el.append(QWeb.render('StripePaymentButton', {}));
//              this.createStripeTerminal();
             core.bus.on('trigger_notification', this, function(title, message, type){
    ...
    _showError(msg, title) {
       core.bus.trigger('trigger_notification', title, msg, 'danger');
    }
    });

    core.action_registry.add('payment_stripe', PaymentStripe);
